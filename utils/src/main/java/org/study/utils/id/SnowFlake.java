...
public class SnowFlake {
    ...
    /**
     * 实现的雪花算法支持32个不同的数据中心或机房，并且在每个数据中心或机房中支持32个机器上部署分布式id服务。
     *
     * @param datacenterId 数据中心id，也可以认为机房id
     * @param machineId    机器id，也可以认为服务所在的服务器id
     */
